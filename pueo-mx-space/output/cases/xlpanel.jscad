...
.extrude({ offset: [0, 0, 4] });
                ...
                function xlpanel_case_fn() {
                    

                // creating part 0 of case xlpanel
                let xlpanel__part_0 = _panel_extrude_4_outline_fn();

                // make sure that rotations are relative
                let xlpanel__part_0_bounds = xlpanel__part_0.getBounds();
                let xlpanel__part_0_x = xlpanel__part_0_bounds[0].x + (xlpanel__part_0_bounds[1].x - xlpanel__part_0_bounds[0].x) / 2
                let xlpanel__part_0_y = xlpanel__part_0_bounds[0].y + (xlpanel__part_0_bounds[1].y - xlpanel__part_0_bounds[0].y) / 2
                xlpanel__part_0 = translate([-xlpanel__part_0_x, -xlpanel__part_0_y, 0], xlpanel__part_0);
                xlpanel__part_0 = rotate([0,0,0], xlpanel__part_0);
                xlpanel__part_0 = translate([xlpanel__part_0_x, xlpanel__part_0_y, 0], xlpanel__part_0);

                xlpanel__part_0 = translate([0,0,0], xlpanel__part_0);
                let result = xlpanel__part_0;
